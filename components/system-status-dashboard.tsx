      ...
      <CardContent className="p-6">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-center gap-4">
                <div
                  className={cn(
                    "rounded-full border-2 h-14 w-14 flex items-center justify-center",
                ...
                <div>
                  <p className="text-gray-400 uppercase text-sm font-medium">Overall Status</p>
              ...
              <div className="flex flex-col justify-center gap-2">
                ...
                <div className="bg-gray-800 rounded-full h-3 w-full overflow-hidden">
                  <div
                    className={cn("h-full rounded-full", getHealthColor(systemHealth))}
        ...
        <div className="grid grid-cols-4 gap-4">
          <Link href="/data-collection/new" className="flex flex-col items-center text-center">
            <div className="h-16 w-16 rounded-full bg-blue-100 dark:bg-blue-900/20 flex items-center justify-center mb-2">
          ...
          <Link href="/resources#shelters" className="flex flex-col items-center text-center">
            <div className="h-16 w-16 rounded-full bg-amber-100 dark:bg-amber-900/20 flex items-center justify-center mb-2">
